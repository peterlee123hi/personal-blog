...
- Don't focus on hype, tech has gone through so many hype cycles (robotics, AR/VR, self-driving cars, crypto, quantum, 3D printing, nanotech). The overall hype has only been real a few times (drones, logistics, AI, cloud, mobile). There's tons of problems to work on outside of hype
